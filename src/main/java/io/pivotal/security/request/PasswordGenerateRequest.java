...
public class PasswordGenerateRequest extends BaseSecretGenerateRequest {
  ...
  public NamedSecret createNewVersion(NamedSecret existing, Encryptor encryptor,
    ...
    PassayStringSecretGenerator passayStringSecretGenerator = applicationContext
        .getBean(PassayStringSecretGenerator.class);
    String newPassword = passayStringSecretGenerator.generateSecret(getGenerationParameters())
        .getPassword();
