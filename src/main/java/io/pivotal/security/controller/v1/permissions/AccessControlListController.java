...
public class AccessControlListController {
  ...
  public ResponseEntity<?> getAccessControlList(
    ...
    return auditLogService.performWithAuditing(auditParams -> {
      ...
      final AccessControlListResponse accessControlListResponse = accessControlHandler.getAccessControlListResponse(userContext, credentialName);
      return new ResponseEntity<>(accessControlListResponse, HttpStatus.OK);
    });
  }
}
